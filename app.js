const members = [
  {
    ...
    role: "ADMINISTRADOR",
    status: "Marcando las reglas",
    bio: "Fundador del grupo y guardián oficial del caos. Organiza los planes, guarda los mejores recuerdos y decide cuándo una historia merece entrar en el archivo de The Big Boy Rules.",
    tags: ["Fundador", "Tecnología", "Real Madrid"],
    stats: ["348", "Mensajes"], 
    bg: "linear-gradient(145deg, #3b2912, #111114 65%)"
  },
  {
    id: 2,
    name: "Miembro 02",
    ...
    role: "ESTRATEGIA",
    status: "Planeando la próxima",
    bio: "El que siempre tiene un plan, aunque nadie sepa exactamente cuál es. Su apartado puede incluir fotos, frases, historias y estadísticas internas del grupo.",
    tags: ["Planes", "Viajes", "Humor"],
    stats: ["221", "Mensajes"],
    bg: "linear-gradient(145deg, #182c2a, #111114 65%)"
  },
  {
    id: 3,
    name: "Miembro 03",
    ...
    role: "IMPREVISIBLE",
    status: "Probablemente liándola",
    bio: "Nunca se sabe qué va a pasar cuando aparece, y precisamente por eso todos quieren que aparezca. Especialista en convertir una tarde normal en una historia legendaria.",
    tags: ["Fiesta", "Memes", "Improvisar"],
    stats: ["305", "Mensajes"],
    bg: "linear-gradient(145deg, #341b27, #111114 65%)"
  },
  {
    id: 4,
    name: "Miembro 04",
    ...
    bio: "El punto de equilibrio cuando el chat empieza a arder. Buen consejero, mejor compañero y experto en recordar al grupo que mañana también existe.",
    tags: ["Consejos", "Calma", "Lealtad"],
    stats: ["198", "Mensajes"],
    bg: "linear-gradient(145deg, #20263a, #111114 65%)"
  },
  {
    id: 5,
    name: "Miembro 05",
    ...
    bio: "Tiene más historias que explicaciones y más frases míticas que mensajes normales. Su perfil es el museo oficial de las mejores anécdotas del grupo.",
    tags: ["Historias", "Música", "Noche"],
    stats: ["414", "Mensajes"],
    bg: "linear-gradient(145deg, #333013, #111114 65%)"
  },
  {
    id: 6,
    name: "Miembro 06",
    nickname: "The Ghost",
    role: "MISTERIO",
    status: "Visto hace 2 minutos",
    bio: "Puede pasar horas sin hablar y aparecer con el mensaje que cambia por completo la conversación. Poco ruido, máximo impacto.",
    tags: ["Misterio", "Gaming", "Observador"],
    stats: ["119", "Mensajes"],
    bg: "linear-gradient(145deg, #252525, #0d0d0f 65%)"
  },
  {
    id: 7,
    name: "Miembro 07",
    nickname: "The Machine",
    role: "MOTOR DEL GRUPO",
    status: "Siempre activo",
    bio: "Nunca rechaza un plan y siempre encuentra energía para uno más. El que mantiene el ritmo cuando los demás empiezan a abandonar.",
    tags: ["Deporte", "Energía", "Planes"],
    stats: ["287", "Mensajes"],
    bg: "linear-gradient(145deg, #2e1c12, #111114 65%)"
  },
  {
    id: 8,
    name: "Miembro 08",
    ...
    role: "INFORMACIÓN",
    status: "Tiene novedades",
    bio: "Sabe lo que pasa antes de que pase. Noticias, rumores, planes y cualquier dato importante suelen llegar primero por su apartado.",
    tags: ["Noticias", "Conexiones", "Humor"],
    stats: ["260", "Mensajes"],
    bg: "linear-gradient(145deg, #162d22, #111114 65%)"
  }
];

const defaultMessages = [
  {member: 5, text: "Entonces, ¿queda confirmado lo del sábado o seguimos fingiendo que sabemos organizarnos?", time: "21:12"},
  {member: 3, text: "Yo ya he dicho que sí. El problema sois los que contestáis tres días después.", time: "21:14"},
  {member: 1, text: "Sábado confirmado. Luego subimos las fotos buenas a Momentos y las demás se quedan clasificadas.", time: "21:16"},
  {member: 8, text: "Tengo sitio localizado. Luego os paso todo por aquí.", time: "21:18"}
];
